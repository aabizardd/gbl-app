...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
        <div class="text-center">
            <img src="{{ asset('images/gbl-logo_white.png') }}" alt="" class="elevation-3"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Direktur HRD</a>
            </div>
        </div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('jabatan') }}"
                        class="nav-link <?= Request::segment(1) == 'jabatan' ? 'active' : '' ?>">
                        <i class="nav-icon fas fa-file"></i>
                        <p>
                            Data Jabatan
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('cuti') }}" class="nav-link <?= Request::segment(1) == 'cuti' ? 'active' : '' ?>">
