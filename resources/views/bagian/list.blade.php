                                                    ...
                                                    <tr>
                                                        ...
                                                        @if (Auth::user()->level == 4)
                                                            <td width=200>
                                                                ...
                                                                <a href="{{ route('bagian.delete', ['id' => $item->id]) }}"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('bagian.update') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="bagian_id" name="bagian_id" value="">

                        <div class="form-group">
                            <label for="exampleInputEmail1">Kode</label>
                            <input type="text" class="form-control @error('kode_update') is-invalid @enderror"
                                id="kode_update" name="kode_update" placeholder="Kode Bagian"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_bagian_update') is-invalid @enderror"
                                id="nama_bagian_update" name="nama_bagian_update" placeholder="Nama Bagian"
...
@section('addScript')
    ...
    <script>
        $(document).on("click", ".edit-data", function() {
            ...
            $(".modal-body #bagian_id").val(id);
            $(".modal-body #kode_update").val(kode);
            $(".modal-body #nama_bagian_update").val(nama);
